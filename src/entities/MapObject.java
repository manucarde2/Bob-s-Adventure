...
public abstract class MapObject
{
    ...
    public boolean isFineLivello()
    {
        return fineLivello;
    }

    public void setFineLivello(boolean fineLivello)
    {
        this.fineLivello = fineLivello;
    }

    public boolean isBloccoDanno()
    {
        return bloccoDanno;
    }

    public void setBloccoDanno(boolean bloccoDanno)
    {
        this.bloccoDanno = bloccoDanno;
    }
