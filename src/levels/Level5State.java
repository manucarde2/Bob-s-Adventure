...
public class Level5State extends GameState
{
    ...
    private  void populateEnemies()
    {
        ...
        /*Entities.Flarby flarby = new Entities.Flarby(tileMap, true, 128, 0.4, 0.6);
        flarby.setPosition(749, 350);
        enemies.add(flarby);

        flarby = new Entities.Flarby(tileMap, true, 128, 0.4, 0.6);
        ...
        flarby = new Entities.Flarby(tileMap, false, 300, 0.4, 0.6);
        flarby.setPosition(1909, 324);
        enemies.add(flarby);

        flarby = new Entities.Flarby(tileMap, false, 128, 0.4, 0.6);
    ...
    public void update()
    {
        ...
        if(player.isHavePowerUp())
        {
            player.setHavePowerUp(false);
            if(player.getSavedPowerUp() != Player.PNORMAL)
            {
                PowerUp powerUp = new PowerUp(tileMap, player.getSavedPowerUp(), player.getTx(), player.getTy());
